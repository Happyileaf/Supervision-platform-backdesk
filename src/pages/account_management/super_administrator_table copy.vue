<template>
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.administrator_account" :placeholder="'账号'" style="width: 170px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.access_level" :placeholder="'权限等级'" style="width: 110px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.owner" :placeholder="'所有者'" style="width: 170px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.department" :placeholder="'所在单位'" style="width: 170px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column :label="'密码'" width="180px" align="center">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.administrator_password }}</span>
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="fetch_general_administrator_list" />

    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item :label="'账号'" prop="administrator_account">
          <el-input v-model="temp.administrator_account" />
        </el-form-item>
        ...
        <el-form-item :label="'权限等级'" prop="access_level">
          <el-select v-model="temp.access_level" class="filter-item" placeholder="Please select">
            <el-option v-for="item in access_levelOptions" :key="item" :label="item" :value="item" />
          </el-select>
...
export default {
  ...
  data() {
    return {
      ...
      temp: {
          ...
          id: '1',
          administrator_account:'100861008610086',
          administrator_password:'123456',
          access_level:'0',
          username:'Happy',
          owner:'春野樱',
          department:'深圳市腾讯计算机系统有限公司',
          status: 'published',
      },
  ...
  methods: {
    fetch_general_administrator_list() {
      axios({
        url: `API/individual/query/${this.listQuery.page}`,
        method: "get",
  ...
  //   },
    ...
    handleModifyStatus(row, status) {
      ...
      axios({
        url: `API/individual${status_interface}`,
        method: "get",
        params: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['序号', '账号', '密码', '权限等级', '用户名','所有者','所在单位','状态']
        const filterVal = ['id', 'administrator_account', 'administrator_password', 'access_level', 'username','owner','department','status']
